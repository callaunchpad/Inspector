...
flayer_title = LSTM(48, return_state=True)
blayer_title = LSTM(48, return_state=True, go_backwards=True)
...
flayer_body = LSTM(48, return_state=True)
blayer_body = LSTM(48, return_state=True, go_backwards=True)
