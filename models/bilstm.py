...
flayer_title = LSTM(52, return_state=True)
blayer_title = LSTM(52, return_state=True, go_backwards=True)
...
flayer_body = LSTM(52, return_state=True)
blayer_body = LSTM(52, return_state=True, go_backwards=True)
...
checkpoint = ModelCheckpoint("./LSTM_saves/lstm_best2.ckpt", monitor='val_acc', verbose=1,
